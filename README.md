...
- [C](#c)
    - [通用机器学习 General-Purpose Machine Learning](#c-general-purpose)
    - [计算机视觉 Computer Vision](#c-cv)
- [C++](#cpp)
    - [计算机视觉 Computer Vision](#cpp-cv)
    - [通用机器学习 General-Purpose Machine Learning](#cpp-general-purpose)
    - [自然语言处理 Natural Language Processing](#cpp-nlp)
    - [序列分析 Sequence Analysis](#cpp-sequence)
    - [手势识别 Gesture Recognition](#cpp-gestures)
- [Common Lisp](#common-lisp)
    - [通用机器学习 General-Purpose Machine Learning](#common-lisp-general-purpose)
- [Clojure](#clojure)
    - [自然语言处理 Natural Language Processing](#clojure-nlp)
    - [通用机器学习 General-Purpose Machine Learning](#clojure-general-purpose)
    - [数据分析/数据可视化 Data Analysis / Data Visualization](#clojure-data-analysis)
- [Erlang](#erlang)
    - [通用机器学习 General-Purpose Machine Learning](#erlang-general-purpose)
- [Go](#go)
    - [自然语言处理 Natural Language Processing](#go-nlp)
    - [通用机器学习 General-Purpose Machine Learning](#go-general-purpose)
    - [数据分析/数据可视化 Data Analysis / Data Visualization](#go-data-analysis)
- [Haskell](#haskell)
    - [通用机器学习 General-Purpose Machine Learning](#haskell-general-purpose)
- [Java](#java)
    - [自然语言处理 Natural Language Processing](#java-nlp)
    - [通用机器学习 General-Purpose Machine Learning](#java-general-purpose)
    - [数据分析/数据可视化 Data Analysis / Data Visualization](#java-data-analysis)
    - [深度学习 Deep Learning](#java-deep-learning)
- [Javascript](#javascript)
    - [自然语言处理 Natural Language Processing](#javascript-nlp)
    - [数据分析/数据可视化 Data Analysis / Data Visualization](#javascript-data-analysis)
    - [通用机器学习 General-Purpose Machine Learning](#javascript-general-purpose)
    - [Misc](#javascript-misc)
- [Julia](#julia)
    - [通用机器学习 General-Purpose Machine Learning](#julia-general-purpose)
    - [自然语言处理 Natural Language Processing](#julia-nlp)
    - [数据分析/数据可视 Data Analysis / Data Visualization](#julia-data-analysis)
    - [Misc Stuff / Presentations](#julia-misc)
- [Lua](#lua)
    - [通用机器学习 General-Purpose Machine Learning](#lua-general-purpose)
    - [Demos and Scripts](#lua-demos)
- [Matlab](#matlab)
    - [计算机视觉 Computer Vision](#matlab-cv)
    - [自然语言处理 Natural Language Processing](#matlab-nlp)
    - [通用机器学习 General-Purpose Machine Learning](#matlab-general-purpose)
    - [数据分析/数据可视化 Data Analysis / Data Visualization](#matlab-data-analysis)
- [.NET](#net)
    - [计算机视觉 Computer Vision](#net-cv)
    - [自然语言处理 Natural Language Processing](#net-nlp)
    - [通用机器学习 General-Purpose Machine Learning](#net-general-purpose)
    - [数据分析/数据可视化 Data Analysis / Data Visualization](#net-data-analysis)
- [Objective C](#objectivec)
    - [通用机器学习 General-Purpose Machine Learning](#objectivec-general-purpose)
- [OCaml](#ocaml)
    - [通用机器学习 General-Purpose Machine Learning](#ocaml-general-purpose)
- [PHP](#php)
    - [自然语言处理 Natural Language Processing](#php-nlp)
    - [通用机器学习 General-Purpose Machine Learning](#php-general-purpose)
- [Python](#python)
    - [计算机视 Computer Vision](#python-cv)
    - [自然语言处理 Natural Language Processing](#python-nlp)
    - [通用机器学习 General-Purpose Machine Learning](#python-general-purpose)
    - [数据分析/数据可视化 Data Analysis / Data Visualization](#python-data-analysis)
    - [Misc Scripts / iPython Notebooks / Codebases](#python-misc)
    - [Kaggle Competition Source Code](#python-kaggle)
- [Ruby](#ruby)
    - [自然语言处理 Natural Language Processing](#ruby-nlp)
    - [通用机器学习 General-Purpose Machine Learning](#ruby-general-purpose)
    - [数据分析/数据可视化 Data Analysis / Data Visualization](#ruby-data-analysis)
    - [Misc](#ruby-misc)
- [Rust](#rust)
    - [通用机器学习 General-Purpose Machine Learning](#rust-general-purpose)
- [R](#r)
    - [通用机器学习 General-Purpose Machine Learning](#r-general-purpose)
    - [数据分析/数据可视化 Data Analysis / Data Visualization](#r-data-analysis)
- [SAS] (#sas)
    - [通用机器学习 General-Purpose Machine Learning] (#sas-general-purpose)
    - [数据分析/数据可视化 Data Analysis / Data Visualization] (#sas-data-analysis)
    - [高性能机器学习 High Performance Machine Learning (MPP)] (#sas-mpp)
    - [自然语言处理 Natural Language Processing] (#sas-nlp)
    - [Demos and Scripts] (#sas-demos)
- [Scala](#scala)
    - [自然语言处理 Natural Language Processing](#scala-nlp)
    - [数据分析/数据可视化 Data Analysis / Data Visualization](#scala-data-analysis)
    - [通用机器学习 General-Purpose Machine Learning](#scala-general-purpose)
- [Swift](#swift)
    - [通用机器学习 General-Purpose Machine Learning](#swift-general-purpose)
- [Credits](#credits)
